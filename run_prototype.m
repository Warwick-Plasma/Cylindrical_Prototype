...
t_end = 30;         % Run-time of simulation
...
foc_x = 5;                   % x-position of focal spot
...
el_x_min = 9.0;             % Initial low-x boundary of e- bunch
el_x_max = 10.0;            % Initial high-x boundary of e- bunch
el_r_min = 0.0;             % Initial low-r boundary of e- bunch
el_r_max = 5.0;             % Initial high-r boundary of e- bunch
el_ppc = 10;                % Number of electrons per cell
